...
ui <- fluidPage(
  sidebarLayout(fluid = T,
    sidebarPanel(
      ...
      # pickerInput("data_source", "Select Data Source:",
      #             choices = c("Betting Markets" = "intrade", "Polling Data" = "polls"), 
      #             selected = "Polling Data",
      #             multiple = F),
      
      dateRangeInput("date_range", "Select Date Range:",
                     start = min(intrade_combined$date), 
  ...
  output$plot <- renderPlotly({
    ...
    probabilities <-
      ...
      ggplot(aes(x = date,
                 ...
                 #                hover_label,": ", democrat_avg_odds)
      )
      ) +
      geom_line(aes(x = date, 
                    y = `Democrat (%)`,
                    # label_new = paste0("Date: ", date,"\n",
                    #             "Democrat ", hover_label,": ", democrat_avg_odds)
                    ),
                colour = "blue") +
      geom_hline(yintercept = 50, colour = "black") +
      geom_line(aes(x = date, 
                    y = `Republican (%)`,
                    # label_new = paste0("Date: ", date,"\n",
                    #             "Republican ",hover_label,": ", republican_avg_odds)
                    ),
                colour = "red") +
